...
var trendingTagsPageSize=10;
var trendingTagsPageIndex=0;
	angular.module('search-trending-tags', ['common-login']).
	config(['$locationProvider', function($locationProvider) {
	$locationProvider.html5Mode(true);
	}])
	.service('searchTrendingTagsService',['$http', '$location', function($http, $location) {	
	return {
	...
	.controller('searchTrendingTagsCtrl',
			[ '$scope', 'searchTrendingTagsService', function($scope, searchTrendingTagsService) {  
		...
		$scope.initFunctionCall = function(){
			...
			if(tagsArray == null || tagsArray == undefined || tagsArray.length <=0){
				var allCategoryPromise = searchTrendingTagsService.getAllTags();
		...
		$scope.addNewRightQuestionButton=function(){
			...
			var questionObjPromise = searchTrendingTagsService.addNewQuestion($scope.rightNewQuestionTitle,content,rightAllCategories,isAnonymousFlag);
		...
		$scope.showAllTrendingTags = function(){
			var allDiscoverTagsPromise = searchTrendingTagsService.getTrendingTags();
		...
		$scope.showAllTrendingQuestions = function(){
			var allTrendingQuestionsPromise = searchTrendingTagsService.getTrendingQuestion();
		...
		$scope.addUserTag = function(tagVal,user_id) {
			var userObjPromise = searchTrendingTagsService.addTagByUserId(tagVal,user_id);
